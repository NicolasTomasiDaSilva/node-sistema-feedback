...
class SequelizeInvitationRepository {
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const model = yield invitation_1.InvitationModel.create(invitation_mapper_1.InvitationMapper.toPersistence(data));
            return invitation_mapper_1.InvitationMapper.toEntity(model);
        });
    }
}
