...
exports.UpdateTemplateController = void 0;
...
class UpdateTemplateController {
    constructor(updateTemplateUseCase, bodyValidator) {
    ...
    handle(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, http_responses_1.ok)((yield this.updateTemplateUseCase.execute(dto)).toJSON());
        });
    }
}
exports.UpdateTemplateController = UpdateTemplateController;
//# sourceMappingURL=update-template-controller.js.map