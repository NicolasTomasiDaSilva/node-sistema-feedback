...
exports.GetTemplatesController = void 0;
...
class GetTemplatesController {
    constructor(getTemplatesUseCase, queryValidator) {
    ...
    handle(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const templates = yield this.getTemplatesUseCase.execute(dto);
            return (0, http_responses_1.ok)(templates.map((t) => t.toJSON()));
        });
    }
}
exports.GetTemplatesController = GetTemplatesController;
//# sourceMappingURL=get-templates-controller.js.map